      ...
      <div className="w-full flex justify-center">
        <footer id="footer-section" className="w-full">
          {isNanoScreen ? (
            ...
            <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex items-center justify-between">
              ...
              {/* Middle section - Policy links - aligned right on desktop */}
              <div className={`flex flex-col sm:flex-row items-center gap-3 ${fontSize} font-['Poppins'] leading-6`}>
              ...
              {/* Right section - Social icons - aligned right on desktop */}
