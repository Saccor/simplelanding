...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-white flex justify-center">
      <div 
        className="w-full max-w-[1440px] flex items-center justify-between bg-white footer-container"
        style={{
          padding: containerPadding,
          // Make sure the layout stays as a row even on small devices
          flexDirection: 'row',
          flexWrap: 'nowrap',
      ...
      >
        ...
        <div className="flex-none flex items-center" style={{ flex: '0 0 auto' }}>
          ...
          >
            <Link href="#" aria-label="YouTube" className="hover:opacity-80 transition-opacity footer-social-icon">
              <svg 
                width={30 * iconScale} 
                height={21 * iconScale} 
                viewBox="0 0 30 21" 
            ...
            <Link href="#" aria-label="Instagram" className="hover:opacity-80 transition-opacity footer-social-icon">
              <svg 
                width={30 * iconScale} 
                height={31 * iconScale} 
                viewBox="0 0 30 31" 
            ...
            <Link href="#" aria-label="LinkedIn" className="hover:opacity-80 transition-opacity footer-social-icon">
              <svg 
                width={30 * iconScale} 
                height={31 * iconScale} 
                viewBox="0 0 30 31" 
