      ...
      <div className="w-full flex justify-center">
        <footer id="footer-section" className="w-full">
          {isNanoScreen ? (
            ...
            <div className="flex flex-col items-center px-[124px] pt-[32px] pb-[24px] gap-[32px] w-full max-w-[1440px] h-[100px] mx-auto">
              <div className="flex flex-row justify-between items-center w-[1192px] h-[41px] gap-[300px]">
                {/* Logo */}
                <Image
                  src="/arfve-logo-dark.svg"
                  alt="Arfve"
