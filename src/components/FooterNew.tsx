    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Link href="https://www.youtube.com/@arfve" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
            <svg width="24" height="17" viewBox="0 0 30 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="https://www.instagram.com/arfve_legacy/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <Link href="https://linkedin.com/company/arfve" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <svg width="24" height="24" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
